...
export default function Header(){
  ...
  return <header className="site-header"><a href="/" className="brand"><span>t</span> TuitionSetu</a><nav><a href="/student">Find classes</a><a href="/tutor/new">For tutors</a><a href="/contact">Contact</a>{loggedIn && <a href="/dashboard">Dashboard</a>}{loggedIn ? <a href="/profile">👤 Profile</a> : <a href="/auth">Log in</a>}</nav></header>
}
